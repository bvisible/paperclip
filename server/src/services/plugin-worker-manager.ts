...
// tools succeed instead of timing out.
// Migration path: PR upstream to expose a per-tool `timeoutMs` field on
// tools.execute so plugins can request longer ceilings without bumping the
// global default.
