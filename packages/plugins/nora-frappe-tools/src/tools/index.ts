...
// Webmail — inbox reading (5) — for the `webmail` agent (incoming-mail triage)
...
import { noraEmailMarkNoraSeen } from "./email/email-mark-nora-seen.js";
...
//// Neoffice Modification: nora-briefings-tools
//// Why: NORA #27 Phase R-V12 — scheduled briefings ("fais-moi un briefing
////      tous les matins"). Backed by Frappe nora.api.v2.briefings + the
////      Raven Bot for in-app delivery. NORA-specific so they live in this
////      Neoffice fork branch, not in upstream Paperclip master.
//// Date: 2026-05-05
//// Refs: NORA [[27-paperclip-neoffice-embed/README]] Phase R-V12
import {
  noraUserHasWhatsapp,
  noraScheduleBriefing,
  noraListBriefings,
  noraPauseBriefing,
  noraResumeBriefing,
  noraDeleteBriefing,
...
//// End Neoffice Modification: nora-briefings-tools

export const ALL_TOOLS: RegisteredToolEntry[] = [
  //// Neoffice Modification: nora-briefings-tools
  // NORA #27 Phase R-V12 — scheduled briefings (Raven / WhatsApp / Email).
  noraUserHasWhatsapp,
  noraScheduleBriefing,
  noraListBriefings,
  noraPauseBriefing,
  ...
  frappeEmailDraft,
  frappeEmailConfirm,
  // Webmail — inbox reading (5)
  noraEmailList,
  noraEmailGet,
  noraEmailSearch,
  noraEmailDownloadAttachment,
  noraEmailMarkNoraSeen,
  // Wave 2 scheduling
